...
namespace Ssigmaapi.Pashiriwebsocket.V1 {
  public static partial class PashiriWebsocketServiceV1
  {
    ...
    {
      serviceBinder.AddMethod(__Method_GetTrades, serviceImpl == null ? null : new grpc::ServerStreamingServerMethod<global::Ssigmaapi.Type.Market, global::Ssigmaapi.Type.Trades>(serviceImpl.GetTrades));
    }
